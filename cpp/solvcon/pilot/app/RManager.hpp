...
public:
    ...
    /// Bound as thread_manager.
    RThreadManager * threadManager() { return m_threadManager; }
...
private:
    ...
    /// Owns the workflow and task threads; shut down in reset().
    RThreadManager * m_threadManager = nullptr;
