...
#
# It is the same as sodtube1darr.py but implementing
# the code by the matrix structure of numby.
#
# Then we could validate our result together with sodtube1darr.py
#
