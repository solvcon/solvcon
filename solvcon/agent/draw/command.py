...
VIEW = {"type": "object",
        "properties": {"pan_x": _cmd.NUMBER, "pan_y": _cmd.NUMBER,
                       "zoom": _cmd.POSITIVE},
...
_BBOX = {"type": "array", "items": _cmd.NUMBER, "minItems": 4, "maxItems": 4,
         "description": "Axis-aligned bounds [min_x, min_y, max_x, max_y]."}
_SEG_LIST = {"type": "array",
             "items": {"type": "array", "items": _cmd.NUMBER,
...
SHAPE = {"type": "object",
         ...
         "properties": {
             "id": _cmd._int("Stable id assigned when the shape was created."),
             "type": {**_cmd.STRING,
...
IMAGE = {"type": "object",
         ...
         "properties": {
             ...
             "width": _cmd._int("Image width in pixels."),
             "height": _cmd._int("Image height in pixels.")},
...
class AddPoint(_cmd.Command):
    ...
    arguments = {"x": _cmd._num("World x of the point."),
                 "y": _cmd._num("World y of the point (+Y up)."),
                 "z": {**_cmd.NUMBER, "default": 0.0,
                       "description": "World z; ignored in 2D."}}
    optional = ("z",)
    returns = {"npoint": _cmd._int("Total free points after the add.")}
...
class AddSegment(_cmd.Command):
    ...
    returns = {"nsegment": _cmd._int("Total bare segments after the add.")}
...
class AddLine(_cmd.Command):
    ...
    arguments = {"x0": _cmd._num("World x of the start point."),
                 "y0": _cmd._num("World y of the start point."),
                 "x1": _cmd._num("World x of the end point."),
                 "y1": _cmd._num("World y of the end point.")}
    returns = {"shape_id": _cmd._int("Id of the new shape.")}
...
class AddTriangle(_cmd.Command):
    ...
    arguments = {"x0": _cmd._num("World x of corner 0."),
                 "y0": _cmd._num("World y of corner 0."),
                 "x1": _cmd._num("World x of corner 1."),
                 "y1": _cmd._num("World y of corner 1."),
                 "x2": _cmd._num("World x of corner 2."),
                 "y2": _cmd._num("World y of corner 2.")}
    returns = {"shape_id": _cmd._int("Id of the new shape.")}
...
class AddRectangle(_cmd.Command):
    ...
    arguments = {"x_min": _cmd._num("Lower-left corner x."),
                 "y_min": _cmd._num("Lower-left corner y."),
                 "x_max": _cmd._num("Upper-right corner x."),
                 "y_max": _cmd._num("Upper-right corner y.")}
    returns = {"shape_id": _cmd._int("Id of the new shape.")}
...
class AddSquare(_cmd.Command):
    ...
    arguments = {"x_min": _cmd._num("Lower-left corner x."),
                 "y_min": _cmd._num("Lower-left corner y."),
                 "size": _cmd._pos("Edge length; must be positive.")}
    returns = {"shape_id": _cmd._int("Id of the new shape.")}
...
class AddEllipse(_cmd.Command):
    ...
    arguments = {"cx": _cmd._num("Center x."), "cy": _cmd._num("Center y."),
                 "rx": _cmd._pos("Semi-axis along x; must be positive."),
                 "ry": _cmd._pos("Semi-axis along y; must be positive.")}
    returns = {"shape_id": _cmd._int("Id of the new shape.")}
...
class AddCircle(_cmd.Command):
    ...
    arguments = {"cx": _cmd._num("Center x."), "cy": _cmd._num("Center y."),
                 "r": _cmd._pos("Radius; must be positive.")}
    returns = {"shape_id": _cmd._int("Id of the new shape.")}
...
class AddBezier(_cmd.Command):
    ...
    returns = {"nbezier": _cmd._int("Total bare Beziers after the add.")}
...
class GetShape(_cmd.Command):
    ...
    arguments = {"shape_id": _cmd._int("Id of the shape to read.")}
    returns = {"shape": SHAPE}
...
class ShapeTypeOf(_cmd.Command):
    ...
    arguments = {"shape_id": _cmd._int("Id of the shape to inspect.")}
    returns = {"type": {**_cmd.STRING,
...
class NShape(_cmd.Command):
    ...
    returns = {"nshape": _cmd._int("Number of live shapes.")}
...
class QueryVisible(_cmd.Command):
    ...
    arguments = {"min_x": _cmd._num("Query box lower-left x."),
                 "min_y": _cmd._num("Query box lower-left y."),
                 "max_x": _cmd._num("Query box upper-right x."),
                 "max_y": _cmd._num("Query box upper-right y.")}
    returns = {"shape_ids": {"type": "array", "items": _cmd.INTEGER,
...
class RenderPng(_cmd.Command):
    ...
    arguments = {"width": {**_cmd.POSITIVE_INT,
                           "description": "Image width in pixels."},
                 "height": {**_cmd.POSITIVE_INT,
                            "description": "Image height in pixels."},
                 "view": {**VIEW,
                          "default": {"pan_x": 0.0, "pan_y": 0.0, "zoom": 1.0},
                          "description": "2D view transform (+Y up)."},
                 "antialiasing": {**_cmd.BOOLEAN, "default": False,
    ...
    def apply(self, world, args, ctx):
        ...
        png = ctx.renderer(world, args["view"], args["width"], args["height"],
                           args["antialiasing"])
...
class TranslateShape(_cmd.Command):
    ...
    arguments = {"shape_id": _cmd._int("Id of the shape to move."),
                 "dx": _cmd._num("World displacement along x."),
                 "dy": _cmd._num("World displacement along y.")}
...
class RemoveShape(_cmd.Command):
    ...
    arguments = {"shape_id": _cmd._int("Id of the shape to remove.")}
...
# Flat package API, derived from the DRAW family after every command above has
# registered; front-ends and tests import these names.
