...
"""
CESE solver specialized for general linear equations with CUDA support.
"""
...
class LincuseCase(CuseCase):
    ...
    def make_solver_keywords(self):
        kw = super(LincuseCase, self).make_solver_keywords()
