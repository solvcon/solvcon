...
class ProfilingTableBuilder:
    ...
    :ivar column_data: The column data represent list of `ProfilingColumnData`.
    :vartype column_data: list[:class:`ProfilingColumnData`]
    :ivar column_width: The column width.
    :vartype column_width: int
    """
...
class ProfilingResultPrinter:
    ...
    :ivar profiling_results: The list of profiling data dictionaries,
        typically generated by a profiler.
    :vartype profiling_results: list[dict[str, typing.Any]]
    """

    def __init__(self, profiling_result: list[dict[str, typing.Any]] = None):
        profiling_result = (
    ...
    def __getitem__(self, function_name: str) -> ProfilingsFunctionResult:
        ...
        :param function_name: The specific function name.
            If function name is absent in profiling result,
            it will raise ValueError.
        :type function_name: str
        :return: The result.
        :rtype: :class:`ProfilingsFunctionResult`
        """
        result = list(
    ...
    def add_column(
        self,
        column_name: str,
        callable: typing.Callable[[ProfilingsFunctionResult], str | float],
    ):
        """
        ...
        :param callable: A lambda or function that calculate value for column.
        :type callable: Callable[[:class:`ProfilingsFunctionResult`],
            str | float]
        """
        self.column_data.append(
            ProfilingColumnData(
    ...
    def print_result(self, column_width=30):
        ...
        :param column_width: The width of column.
